        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Annual Progress Report</li>
                </ul><!-- /.breadcrumb -->
            </div>
                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">
                                                    <i class="fa fa-plus-circle"></i> Add New<span class="hide-in-sm">
                                                        Admin-User
                                                    </span>
                                                </h4>
                                                ...
                                                <span class="widget-toolbar">
                                                    ...
                                                    <a href="{{ route('user') }}" class="">
                                                        <i class="fa fa-list"></i> User <span class="hide-in-sm">List</span>
                                                    </a>
                                                </span>
                                            </div>
                                                ...
                                                <div class="widget-main">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group width-100 mb-1">
                                                                    <span class="input-group-addon width-20"
                                                                        ...
                                                                        Name <span
                                                                            class="label-required text-danger">*</span>
                                                                    </span>
                                                    ...
                                                    <div class="form-group">
                                                        <h5 class="widget-title">
                                                            <div class="row"
                                                                style="margin-top: 20px !important;padding:5px">

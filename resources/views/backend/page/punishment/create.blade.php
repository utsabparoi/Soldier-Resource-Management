                                                            ...
                                                            <div align="left" class="form-group">
                                                                <div align="left"><label
                                                                        ...
                                                                        for="form-field-1"><h4><strong>Add
                                                                                Punishment</strong></h4></label></div>
                                                                <div class="form-group">
                                                                    <table class="table" width="100%">
                                                                        ...
                                                                        <tr class="remove_able_tr_punishment">
                                                                            <td>
                                                                                <input type="text" class="form-control"
                                                                                       name="punishment_date[]" id="">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" class="form-control"
                                                                                       name="punishment_baa_section[]"
                                                                                       id="">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" class="form-control"
                                                                                       name="punishment_offence[]"
                                                                                       id="">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" class="form-control"
                                                                                       name="punishment_type[]" id="">
                                                                            </td>
                                                                            <td>
                                                                                <button type="button"
                                                                                        class="btn btn-danger btn-sm removeEventPunishment">
                                                                                    -
                                                                                </button>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button type="button"
                                                                                        class="btn btn-info btn-sm addEventPunishment">
                                                                                    +
                                                                                </button>
                                                                            </td>
                                                                        </tr>

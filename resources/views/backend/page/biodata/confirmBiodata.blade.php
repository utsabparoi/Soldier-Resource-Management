        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Biodata Confirm</li>
                </ul><!-- /.breadcrumb -->
                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">
                                                    <i class="fa fa-plus-circle"></i> <span class="hide-in-sm">Biodata Preview of Mr. X  </span>
                                                </h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4" style="margin-top: 22px;">
                                                            <div style="border: 1px solid #a3a3a3; width: 50%; padding-left: 8px;">
                                                                <span><h5><strong>Present Loc: Dhaka</strong></h5></span>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <img src="{{ asset('backend/images/person.png') }}" width="110px" height="110px">
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <table border="1" width="80%" style="font-size: 17px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="76%" style="padding-left: 5px;">12/12/2022</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="76%" style="padding-left: 5px;">12/12/2052</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="76%" style="">
                                                                        <table width="100%">
                                                                            <thead>
                                                                            <tr>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1;">Name of Course</td>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1;">Result</td>
                                                                                <td  class="text-center" style="">Remarks</td>
                                                                            </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                            <tr>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1; border-bottom: 1px solid #a1a1a1; border-top: 1px solid #a1a1a1;">-</td>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1; border-bottom: 1px solid #a1a1a1; border-top: 1px solid #a1a1a1;">-</td>
                                                                                <td  class="text-center" style="border-bottom: 1px solid #a1a1a1; border-top: 1px solid #a1a1a1;">-</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1; border-bottom: 1px solid #a1a1a1; border-top: 1px solid #a1a1a1;">-</td>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1; border-bottom: 1px solid #a1a1a1; border-top: 1px solid #a1a1a1;">-</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="76%" style="">
                                                                        <table width="100%">
                                                                            <thead>
                                                                            <tr>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1;">No of Punishment</td>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1;">BAA Section</td>
                                                                                <td  class="text-center" style="border-right: 1px solid #a1a1a1;">Description Offence</td>
                                                                                <td  class="text-center" style="">Type of Punishment</td>
                                                                            </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                            <tr>

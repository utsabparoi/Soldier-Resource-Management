                                    ...
                                    <div class="col-12">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                ...
                                                <!--------------- Slider List---------------->
                                                <a href="{{ route('prm.leave-category.index') }}" class="">
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    ...
                                                    <form action="{{ route('prm.leave-category.update',$leave_category->id) }}" id="Form" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="input-group-addon width-30" style="text-align: left">
                                                                        ...
                                                                        <input type="text" class="form-control @error('name') has-error @enderror"
                                                                               name="name" id="name" value="{{ old('name', $leave_category->name) }}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="input-group-addon width-30" style="text-align: left">
                                                                        ...
                                                                        <label style="margin: 5px 0 0 8px">
                                                                            <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" {{ $leave_category->status == 1 ? 'checked' : '' }}>
                                                                            <span class="lbl"></span>
                                                                        </label>
                                                                    </div>
                                                                </div>

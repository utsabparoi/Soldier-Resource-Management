                ...
                <div class="widget-box">
                    ...
                    <div class="widget-header">
                        ...
                        <span class="widget-toolbar">
                            <!--------------- CREATE---------------->
                            <a href="{{ route('prm.leave-category.create') }}" class="">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                                        <table id="dynamic-table"
                                            ...
                                            @forelse($leave_categories as $category)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <div class="btn-group btn-corner  action-span ">
                                                            ...
                                                            <a href="{{ route('prm.leave-category.edit', $category->id) }}"
                                                            ...
                                                            <button type="button"
                                                                    onclick="delete_item(`{{ route('prm.leave-category.destroy', $category->id) }}`)"
                                        ...
                                        @include('partials._paginate',['data'=> $leave_categories])
                                    </div>
                                </div>
                            </div>
                        </div>

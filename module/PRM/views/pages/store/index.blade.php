            ...
            <div class="page-content">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-header">
                        <h4 class="widget-title"> <i class="fa fa-info-circle"></i> Store List
                        </h4>
                                    ...
                                    <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                                        <table id="dynamic-table"
                                            ...
                                            <tr>
                                                ...
                                                <th width="25%">Name</th>
                                                <th class="text-center" width="25%">Store Man</th>
                                                <th class="text-center" width="25%">Camp</th>
                                            ...
                                            @forelse($store as $stores)
                                                <tr>
                                                    ...
                                                    <td><span class="span">{{$stores->name}}</span></td>
                                                    <td class="text-center"><span class="span">{{$stores->store_man}}</span></td>
                                                    <td class="text-center"><span class="span">{{\Module\PRM\Models\Camp::where('id', $stores->camp_id)->first()->name}}</span></td>
                                                    <td class="text-center">
                                                        <!--------------- STATUS EDIT---------------->
                                                        <div>
                                                            <label>
                                                                <span class="span">
                                                            <x-status status="{{ $stores->status }}" id="{{ $stores->id }}" table="{{ $table }}" />
                                                        </span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        ...
                                                        <div class="btn-group btn-corner  action-span ">
                                                            ...
                                                            <a href="{{ route('prm.store.edit', $stores->id) }}"
                                                            ...
                                                            <button type="button"
                                                                    onclick="delete_item(`{{ route('prm.store.destroy', $stores->id) }}`)"
                                        ...
                                        @include('partials._paginate',['data'=> $store])
                                    </div>
                                </div>
                            </div>
                        </div>
